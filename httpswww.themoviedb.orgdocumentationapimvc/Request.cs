...
//16.7.2021. I change every namespace, using and assembly TmdbEasy to
//namespace, using and assembly httpswww.themoviedb.orgdocumentationapimvc
//because that's my project name
